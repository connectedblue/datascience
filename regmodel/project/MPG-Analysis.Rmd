...
conf_int<-(cbind(confint(fit_am_wt_hp), Model_coef=coef(fit_am_wt_hp)))
...
The Model_coef value for the Intercept shows that the mean MPG for a manual car of average weight and horsepower is `r round(conf_int[[4,1]], 2)`.  19.24.  The co-efficients for the other terms in the model show the relative increase or decrease per unit increase in the associated variable.
...
The plots in the appendix show the diagnostics for this selected model.  The QQ plot is along the expected line, indicating that the errors are guassian.  Furthermore, the residuals plot shows the Cook distance is less than 0.5 for all data points

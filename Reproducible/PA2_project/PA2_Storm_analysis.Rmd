...
fatalities<-sumcolumn(analysis_events, "EVTYPE","event_fatalities")
injuries<-sumcolumn(analysis_events, "EVTYPE","event_injuries")
property<-sumcolumn(analysis_events, "EVTYPE","event_property_damage")
crops<-sumcolumn(analysis_events, "EVTYPE","event_crop_damage")


top_ten_impacts <- cbind(data.frame(n=c(1:10,"","")),
                         totalcrunch(fatalities, 1:10, "(OTHERS)"),
                         totalcrunch(injuries , 1:10, "(OTHERS)",""),
                         totalcrunch(property , 1:10, "(OTHERS)",""),
                         totalcrunch(crops , 1:10, "(OTHERS)","")
                         )
...
kable(top_ten_impacts, digits=0, format.args=list(big.mark = ','),
      ...
      col.names = c("","", "Fatalities", "", "Injuries", "","Property Damage ($'000)","", "Crop Damage ($'000)"))

summary_table(analysis_events, "EVTYPE", c("event_fatalities","Fatalities"), c("event_injuries","Injuries"), sprintf("Top 10 Public Health and economic impacts %d - 2011", start_year))

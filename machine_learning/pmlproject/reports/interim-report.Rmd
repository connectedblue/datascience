...
We can see that there are `r na_tab[2,2]` columns with no missing values at all.  Of the remainder, the vast majority of observations are missing.  We decided to ignore these columns also in the analysis, and keep only the `r na_tab[2,2]` complete columns.

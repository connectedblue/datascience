...
`r caretrf_submitted_answers`

The final model predicts an an accuracy of `r round(max(caretrf_mod$results[,2])*100,2)`%.  This means that the out of sample error rate is `r round(1-max(caretrf_mod$results[,2])*100,2)`%.

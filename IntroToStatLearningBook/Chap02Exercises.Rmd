...
{\color{blue}\begin{tt}\begin{adjustwidth}{2.5em}{0pt}}
{\end{adjustwidth}\end{tt}}

\newenvironment{theiranswer}
{\color{red}\begin{tt}\begin{adjustwidth}{2.5em}{0pt}\underline{\textbf{Unofficial Solution:}}\newline\newline}
{\end{adjustwidth}\end{tt}}
...
(b)  The success of the project is categorical (success/fail) so this is a classification problem.  It is a prediction problem because we just want to know the outcome, not the relationship between the predictors and the outcome.  $n$ is 20 and $p$ is 13.
